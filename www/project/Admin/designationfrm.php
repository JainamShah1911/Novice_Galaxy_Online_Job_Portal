...
<script type="text/javascript" >            
            function validate(objForm){
                if(objForm.designationid.value.length==0){
                    alert("Please enter designation id");
                    objForm.designationid.focus();
                    return false;
                }
               
                if(objForm.designationname.value.length==0){
                    alert("Please Enter designation name");
                    objForm.designationname.focus();
                    return false;
                }
...
$dsid = $_POST['designationid'];
$dsname=$_POST['designationname'];

$st = "insert into designation_mst values (".$dsid.",'".$dsname."')";
...
<div id="tempatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <div id="content_panel">
			 ...
			 <form name="designation_mstfrm" action="" method="post" onsubmit="return validate(this)">
			  <table>
			  <tr>
			  <td></td><td>DESIGNATION INFORMATION FORM</td><td></td></tr>
				<tr><td> Designation id</td>
				<td><input type="text" name="designationid" id="designationid" size="5" onkeypress="return numeric(event);"/></td>
				<td></td>
				</tr>
				<tr><td> Designation name</td>
				<td><input type="text" name="designationname" id="designationname" size="5" onkeypress="return string(event);" /></td>
				<td></td>
				</tr>
				<tr>
				<td></td>
...
<div align=center>Site design for : ITM  Designed  By : Jainam, Purva, Kartavi</div>
</body>
</html>
