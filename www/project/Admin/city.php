...
<script type="text/javascript" >            
            function validate(objForm){
                ...
                if(objForm.cityid.value.length==0){
...
<div id="tempatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <div id="content_panel">
        	 <div id="column_w610">
			  <form name="cityfrm" action="" method="post" onsubmit="return validate(this)">
			  <table>
			  <tr>
			  <td></td><td>CITY INFORMATION FORM</td><td></td></tr>
			 <tr>
...
$st = "insert into citymst values (".$cityid.",'".$cityname."','".$stateid."')";
...
?>
<td>SELECT STATENAME </td><td><select id="statename" name="statename" >
...
<tr>			  <td> CITY ID</td><td><input type="text" name="cityid" id="cityid" size="5" onkeypress="return numeric(event);" /></td><td></td></tr>
			  <tr><td> CITY NAME</td><td><input type="text" name="cityname" id="cityname" size="25" onkeypress="return string(event);" /></td><td></td></tr>
