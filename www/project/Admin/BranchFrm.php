...
$st = "insert into branch_mst values (".$bid.",'".$bname."')";
        ...
        <div id="content_panel">
			 ...
			 <form name="branch_mstfrm" action="" method="post" onsubmit="return validate(this)">
			  ...
			  <td></td><td>BRANCH INFORMATION FORM</td><td></td></tr>
				<tr><td> BRANCH ID</td>
				<td><input type="text" name="branchid" id="branchid" size="5" onkeypress="return numeric(event);"/></td>
				<td></td>
				</tr>
				<tr><td> BRANCH NAME</td>
				<td><input type="text" name="bname" id="bname" size="5" onkeypress="return string(event);"/></td>
				<td></td>
				</tr>
				<tr>
				<td></td>
