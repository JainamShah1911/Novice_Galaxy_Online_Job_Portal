...
<script type="text/javascript" >            
            function validate(objForm){
                if(objForm.qid.value.length==0){
                    alert("Please enter que id");
                    objForm.qid.focus();
                    return false;
                }
               
                if(objForm.qdesc.value.length==0){
...
$st = "insert into question_mst values (".$qid.",'".$qdesc."')";
...
<div id="tempatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <div id="content_panel">
			 ...
			 <form name="question_mstfrm" action="" method="post" onsubmit="return validate(this)">
			  <table>
			  <tr>
			  <td></td>
			  <td>QUESTION INFORMATION FORM</td>
			  <td></td>
			  </tr>
				<tr>
				<td> QUESTION ID</td>
				<td><input type="text" name="qid" id="qid" size="5" onkeypress="return numeric(event);"/></td>
				<td></td>
				</tr>
			  <tr>
			  <td> QUESTION DESCRIPTION</td>
			    <td><textarea name="qdesc" rows="5" cols="90"id="qdesc" ></textarea></td>
			    <td></td>
				</tr>
				<tr>
				<td></td>
