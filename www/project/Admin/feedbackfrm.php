...
$fid = $_POST['feedid'];
$fdate=$_POST['feeddate'];
$uid=$_POST['uid'];
$fdesc=$_POST['feeddesc'];
$reply=$_POST['reply'];
$status=$_POST['status'];


$st = "insert into feedback values (".$fid.",".$fdate.",".$uid.",'".$fdesc."','".$reply."','".$status."')";
...
<div id="tempatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <div id="content_panel">
			 ...
			 <form name="feedbackfrm" action="" method="post">

			  <table>
			  <tr>
			  <td></td><td>FEEDBACK INFORMATION FORM</td><td></td></tr>
				<tr><td> Feedback id</td>
				<td><input type="text" name="feedid" id="feedid" size="5" onkeypress="return numeric(event);"/></td>
				<td></td>
				</tr>
				<tr><td> Fededback date</td>
				<td><input type="date" name="feeddate" id="feeddate" /></td>
				<td></td>
				</tr>
				<tr>
				<?php 
				...
				<tr><td> Feedback description</td>
				<td><input type="text" name="feeddesc" id="feeddesc" size="100"/></td>
				<td></td>
				</tr>
				<tr><td> Reply</td>
				<td><input type="text" name="reply" id="reply" size="100"/></td>
				<td></td>
				</tr>
				<tr><td> Status</td>
				<td><input type="text" name="status" id="status" size="50" /></td>
				<td></td>
				</tr>
				<tr>
