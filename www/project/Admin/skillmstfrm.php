...
<script type="text/javascript" >            
            function validate(objForm){
                if(objForm.skillid.value.length==0){
                    alert("Please enter skill id");
                    objForm.skillid.focus();
                    return false;
                }
               
                if(objForm.skilldesc.value.length==0){
                    alert("Please Enter skill description");
                    objForm.skilldesc.focus();
                    return false;
                }
...
$skid = $_POST['skillid'];
$skdesc=$_POST['skilldesc'];

$st = "insert into skill_mst values (".$skid.",'".$skdesc."')";
...
<div id="tempatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <div id="content_panel">
			 ...
			 <form name="skill_mstfrm" action="" method="post" onsubmit="return validate(this)">
			  <table>
			  <tr>
			  <td></td><td>SKILL INFORMATION FORM</td><td></td></tr>
				<tr><td> Skill id</td>
				<td><input type="text" name="skillid" id="skillid" size="5" onkeypress="return numeric(event);"/></td>
				<td></td>
				</tr>
				<tr><td> Skill description</td>
				<td><input type="text" name="skilldesc" id="skilldesc" size="5" /></td>
				<td></td>
				</tr>
				<tr>
				<td></td>
