...
<script type="text/javascript" >            
            function validate(objForm){
                if(objForm.qlid.value.length==0){
                    alert("Please enter qualification id");
                    objForm.qlid.focus();
                    return false;
                }
               
                if(objForm.qldesc.value.length==0){
                    alert("Please Enter qualification description");
                    objForm.qldesc.focus();
                    return false;
                }
...
$st = "insert into qualification values (".$qlid.",'".$qldesc."')";
...
<div id="tempatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <div id="content_panel">
			...
			<form name="Qualification_frm" action="" method="post" onsubmit="return validate(this)">
			  <table>
			  <tr>
			  <td></td><td>QUALIFICATION INFORMATION FORM</td><td></td></tr>
				<tr><td> Qualification id</td>
				<td><input type="text" name="qlid" id="qlid" size="5" onkeypress="return numeric(event);" /></td>
				<td></td>
				</tr>
				<tr><td> Qualification Description</td>
				<td><input type="text" name="qldesc" id="qldesc" size="5" onkeypress="return string(event);"/></td>
				<td></td>
				</tr>
				<tr>
				<td></td>
