...
$st = "insert into company_branch values (".$compid.",'".$branchid."')";
...
<div id="tempatemo_content_wrapper">
    ...
    <div id="templatemo_content">
        ...
        <div id="content_panel">
			...
			<form name="company_branchfrm" action="" method="post">
			  <table>
			  <tr>
			  <td></td><td>COMPANY BRANCH INFORMATION FORM</td><td></td></tr>
				<tr>
				<?php 
...
?>
				...
				<td> Company id</td>
				<td><select id="compid" name="compid">
