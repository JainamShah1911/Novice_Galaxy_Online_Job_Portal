...
$st = "insert into company_requirement values (".$reqid.",".$reqdate.",".$fdate.",".$tdate.",".$brnid.",".$desid.",'".$post."',".$quaid.",".$skid.")";
    ...
    <div id="templatemo_content">
        ...
        <div id="content_panel">
			 ...
			 <form name="branch_mstfrm" action="" method="post">
			  ...
			  <table>
			  <tr>
			  <td></td><td>COMPANY REQUIREMENT FORM</td><td></td></tr>
				<tr><td> Requirement id</td>
				<td><input type="text" name="reqid" id="reqid" size="5" onkeypress="return numeric(event);" /></td>
				<td></td>
				</tr>
				<tr><td> Requirement date</td>
				<td><input type="date" name="reqdate" id="reqdate"  /></td>
				<td></td>
				</tr>
				<tr><td> Period date from</td>
				<td><input type="date" name="fromdate" id="fromdate"  /></td>
				<td></td>
				</tr>
				<tr><td> Period date to</td>
				<td><input type="date" name="todate" id="todate" size="5" /></td>
				<td></td>
				</tr>
				<tr>
				<?php 
				...
				$st = "select * from designation_mst";
				...
				<td><select name="desid" id="desid">
				<option>---Select---</option>
			  	<?php
				while($row = mysql_fetch_assoc($result))
				{
					echo '<option value="'. $row['desgid'] .'" >' .$row['desgname']. '</option>';
				}
				...
				<tr><td> No of post</td>
				<td><input type="text" name="no_of_post" id="no_of_post" size="5" /></td>
				<td></td>
				</tr>
				<tr>
				<?php 
				...
				<td><select name="quaid" id="quaid">
				<option>---Select---</option>
			  	<?php
				while($row = mysql_fetch_assoc($result))
				{
					echo '<option value="'. $row['qualificationid'] .'" >' .$row['qualificationdesc']. '</option>';
				}
				...
				<td> Skill id</td>
				<td><select name="skid" id="skid">
				<option>---Select---</option>
			  	<?php
				while($row = mysql_fetch_assoc($result))
				{
					echo '<option value="'. $row['skillid'] .'" >' .$row['skilldesc']. '</option>';
				}
				...
				<tr>
				<td><input type="submit" name="submit" value="submit" size="5" /></td>
				<td></td>
				</tr>
			</table>
		</form>
